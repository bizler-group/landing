...
export default function TermsAndConditions() {
  ...
  return (
    <main
      className={`container text-white min-h-screen ${nunitoSans.className} flex items-center flex-col justify-center overflow-hidden relative z-50`}
    >
      <h1 className="text-3xl text-white text-center">Terms and Conditions</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Bizler Group LLC, Qaraqalpaqstan
            Respublikası, Nókis qalası, Kók Ózek MPJ, Abılǵazı bajban kóshesi,
            71-úy.
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: bizler.group@gmail.com</p>
        </li>
        <li>
          <p>By phone number: +998906601020</p>
        </li>
      </ul>
    </main>
  )
